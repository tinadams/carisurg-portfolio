...
| Workflow Disruption (Triage Takes Longer)                          | Operational  |          M |      H | The AI flag appears automatically, without requiring extra steps from nurses.                                    | Average triage time does not increase after the tool is introduced. Ideally, triage time decreases.                                     |
...
| No Clear Person Responsible                  | Ethical      |          M |      H | Decide and define who is responsible for model approval, monitoring, clinical use, and response to harm before deployment.                                                             | A named clinical lead and technical lead are listed.                    |
